  ...
  return (
    <div className=" w-full overflow-hidden">
      {data.length !== 0 && data ? (
                  ...
                  <table className="min-w-full border-gray-50   table-fixed border-collapse text-right text-sm font-light">
                    <thead className="font-medium  dark:border-neutral-500 ">
                      <tr className="text-gray-400   border-b  border-gray-50  ">
                        <th className="px-3 py-4 text-center ">نوع تراکنش</th>
        ...
        <div className=" w-full min-h-[230px]  md:flex justify-center items-center text-center text-gray-200">
  ...
  return (
    <>
      ...
      <div className=" px-4  flex flex-col gap-y-3">
        <div className=" flex rounded-2xl  border border-gray-50 justify-center items-center gap-y-6  h-[220px] flex-col md:hidden">
