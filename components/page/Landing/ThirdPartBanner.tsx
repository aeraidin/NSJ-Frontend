            ...
            <div className='grid grid-rows-3 grid-cols-1 lg:grid-rows-1 lg:grid-cols-3 gap-y-5 lg:gap-y-0 lg:gap-x-5 '>
                ...
                <div className='grid grid-cols-2 lg:grid-cols-1 gap-5 '>
                    <div className='relative'>
                        <Image src={LeftTopBanner} fill className='object-cover rounded-2xl' alt='Banner' placeholder='blur' />
                    </div>
                    <div className='relative'>
                        <Image src={LeftBottomBanner} fill className='object-cover rounded-2xl' alt='Banner' placeholder='blur' />
                    </div>
                </div>
            </div>
